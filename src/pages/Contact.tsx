        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl opacity-90 leading-relaxed slide-up">
              ...
              message – we're always here to help.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-muted-foreground">
                        Located in the heart of downtown, we're easily
                        accessible by public transport and have street parking
                        available.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card className="shadow-soft">
                  <CardHeader>
                    ...
                    <CardDescription>
                      ...
                      updates, events, and behind-the-scenes content.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card className="shadow-soft accent-gradient text-accent-foreground">
                  <CardHeader>
                    ...
                    <CardDescription className="text-accent-foreground/80">
                      Subscribe to our newsletter for special offers, events,
                      and coffee tips.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
